import type { Project, ExperienceItem, SkillCategory, EducationItem, LanguageItem } from '../types';
...
export const PERSONAL_INFO = {
  ...
  github: 'https://github.com/abdullah-radwan',
  linkedin: 'https://linkedin.com/in/abdullah-radwan',
...
export const PROJECTS: Project[] = [
  {
    ...
    isFeatured: true,
    date: 'Live — July 2026',
    description: 'AI-driven contract analysis platform enabling automated PDF document analysis, risk and compliance assessment, tier-based billing, usage quota tracking, and real-time email notifications.',
    ...
    technologies: ['React', 'NestJS', 'Prisma', 'Open Router AI', 'PostgreSQL', 'TypeScript'],
    features: [
    ...
    metrics: ['July 2026 Launch', 'AI OpenRouter Engine', 'Full SaaS Quota Engine'],
    githubUrl: 'https://github.com/abdullah-radwan/docky-ai-saas',
    liveUrl: 'https://docky-ai-demo.dev',
    architectureNotes: [
  ...
  },
  {
    ...
    description: 'Comprehensive project management platform featuring granular Role-Based Access Control (RBAC), team member invitations, real-time activity feeds, and notification management.',
    longDescription: 'APEX delivers a seamless workflow solution for agile development teams. Built with React.js on the frontend and NestJS with Drizzle ORM on Neon PostgreSQL serverless database. Implements tight RBAC policies, organization member invitations, and real-time state synchronization.',
    technologies: ['React.js', 'NestJS', 'Drizzle ORM', 'Neon PostgreSQL', 'TypeScript'],
    features: [
    ...
    githubUrl: 'https://github.com/abdullah-radwan/apex-project-manager',
    liveUrl: 'https://apex-pm.dev',
    architectureNotes: [
  ...
  },
  {
    ...
    subtitle: 'Enterprise-grade e-commerce application with Server-Side Rendering',
    category: 'web',
    date: 'Live — May 2026',
    description: 'High-performance e-commerce platform built with Angular and NestJS featuring Server-Side Rendering (SSR), optimized checkout workflows, and strict engineering best practices.',
    longDescription: 'An enterprise e-commerce platform engineered for speed, SEO indexability, and reliability. Leverages Angular Universal/SSR alongside a NestJS micro-service backend. Achieved 100% Best Practices and 95% SEO scores in Google Lighthouse audits.',
    technologies: ['Angular', 'NestJS', 'SSR', 'TypeScript', 'Node.js', 'REST API'],
    features: [
    ...
    githubUrl: 'https://github.com/abdullah-radwan/angular-nestjs-ecommerce',
    liveUrl: 'https://angular-store.dev',
    architectureNotes: [
  ...
  },
  {
    ...
    description: 'Modern, ultra-fast online shopping platform powered by Next.js App Router, Prisma ORM, PostgreSQL, and Stripe payment gateway integration.',
    longDescription: 'Engineered with Next.js App Router, this storefront delivers lightning-fast page loading and seamless payment flow. Reached 98% SEO score and 95% Performance rating on Google Lighthouse audits. Features secure Stripe checkout webhooks and dynamic product recommendations.',
    technologies: ['Next.js', 'Prisma', 'PostgreSQL', 'Stripe', 'Tailwind/CSS', 'TypeScript'],
    features: [
    ...
    githubUrl: 'https://github.com/abdullah-radwan/nextjs-stripe-store',
    liveUrl: 'https://nextjs-storefront.dev',
    architectureNotes: [
  ...
  },
  {
    ...
    description: 'Cross-platform mobile social experience built with React Native and Expo, featuring Clerk biometric/social authentication and Convex real-time backend sync.',
    longDescription: 'A responsive mobile social application delivering instant messaging, live activity feeds, and media uploads across iOS and Android. Utilizes Expo framework with Clerk for auth and Convex for reactive real-time database state synchronization.',
    technologies: ['React Native', 'Expo', 'Clerk Auth', 'Convex', 'TypeScript'],
    features: [
    ...
    githubUrl: 'https://github.com/abdullah-radwan/rn-social-convex',
    liveUrl: 'https://rn-social-demo.dev',
    architectureNotes: [
...
export const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    description: 'Intensive software development program focusing on professional software delivery practices, architecture design, requirement modeling, and AI-assisted development workflows.',
    highlights: [
    ...
    technologies: ['BRD/PRD', 'Jira', 'AI Stacks', 'GitHub', 'Agile', 'Debugging', 'Software Architecture']
  },
  {
    id: 'nti-mean',
    ...
    description: 'Specialized full-stack web engineering training program covering modern JavaScript/TypeScript web architectures, REST APIs, authentication security, and document databases.',
    highlights: [
    ...
    technologies: ['Angular', 'Node.js', 'Express', 'JWT Auth', 'MongoDB', 'REST APIs', 'TypeScript']
  }
];
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    skills: ['TypeScript', 'Next.js', 'Angular', 'React', 'React Native', 'TanStack', 'Redux', 'Zustand', 'Tailwind']
  },
  {
    title: 'Backend & Databases',
    iconName: 'Database',
    description: 'Designing robust API services, database schemas, ORM layers, and microservices.',
    skills: ['Node.js', 'NestJS', 'GraphQL', 'PHP', 'SQL', 'PostgreSQL', 'MongoDB', 'Prisma', 'Drizzle', 'Database Design']
  },
  {
    title: 'Engineering & Delivery',
    iconName: 'Terminal',
    description: 'Translating business specs into clean software architecture, requirement specs, and agile execution.',
    skills: ['Software Architecture', 'Caching', 'BRD/PRD', 'Requirements Analysis', 'Requirements Clarification', 'Jira', 'Debugging']
  },
  {
    title: 'DevOps & Workflow',
    iconName: 'GitBranch',
    description: 'Streamlining CI/CD pipelines, version control, containerization, and team collaboration.',
...
export const LANGUAGES: LanguageItem[] = [
  { language: 'English', proficiency: 'Fluent', level: 'Full Professional Proficiency' },
  { language: 'Deutsch', proficiency: 'Beginner', level: 'Elementary Proficiency (A1/A2)' }
];
